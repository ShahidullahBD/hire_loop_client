...
export default function CompanyProfile({ recruiter, recruiterCompany }) {
    ...
    const handleLogoUpload = async (e) => {
        ...
        try {
            ...
            const IMGBB_API_KEY = process.env.NEXT_PUBLIC_IMAGBB_API_KEY; 
            ...
            <div className="max-w-4xl mx-auto my-8 bg-zinc-950 border border-zinc-900 rounded-xl p-8 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-900 pb-6">
                    <div className="flex items-center gap-4">
                        {company.logo ? (
                            <Image height={30} width={30} src={company.logo} alt={company.name} className="w-16 h-16 rounded-xl object-contain bg-zinc-900 p-2 border border-zinc-800" />
                        ) : (
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            ...
                            <div className="flex items-center gap-4 mt-1">
                                <label className="w-14 h-14 border border-dashed border-zinc-700 hover:border-zinc-500 bg-zinc-900/40 rounded-xl flex flex-col items-center justify-center cursor-pointer transition-colors group relative overflow-hidden">
                                    ...
                                    />
                                    {logoUrl ? (
                                        <Image width={30} height={30} src={logoUrl} alt="Logo Preview" className="w-full h-full object-cover" />
                                    ) : (
